...
def generate_visuals():
    ...
    plt.tight_layout()
    plt.savefig('niche_steering.png', dpi=300)
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('algorithm_overlap.png', dpi=300)
    plt.close()
    ...
    plt.ylim(0, 30)
    plt.tight_layout()
    plt.savefig('recall_performance.png', dpi=300)
    plt.close()

    print("Success! Generated niche_steering.png, algorithm_overlap.png, and recall_performance.png")
